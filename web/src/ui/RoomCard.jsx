...
import { Icon, Toggle, introIndex } from './bits.jsx';
...
export function RoomCard(props) {
  ...
  return (
    <div class="room-card" role="button" tabindex="0" style={ei != null ? { '--i': ei } : undefined}
      ...
      <Toggle checked={on() > 0} pending={r().lights.some((u) => u.pending())} label={`${r().name} lights`}
